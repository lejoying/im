...
public class AppShortCutUtil {
	...
	public static boolean isAuthority(Context context) {
	...
	public static boolean isAddShortCut(Context context) {
		...
		/*
		 * int versionLevel = android.os.Build.VERSION.SDK_INT; String AUTHORITY = "com.android.launcher2.settings"; //2.2以上的系统的文件文件名字是不一样的 if (versionLevel >= 8) { AUTHORITY = "com.android.launcher2.settings"; } else { AUTHORITY = "com.android.launcher.settings"; }
		 */
	...
	public static String getAuthorityFromPermission(Context context, String permission) {
		...
		if (packInfos == null) {
			packInfos = context.getPackageManager().getInstalledPackages(0);
			if (packInfos == null) {
				return null;
			}
		}
	 ...
	 * <br>
	 * 
	 *            注意点： context.getPackageName()+"/."+clazz.getSimpleName() （这个是启动activity的路径）中的"/."不能缺少
	 * 
	 */
