...
public class BusinessCardActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mStatus = intent.getIntExtra("mStatus", 1);
		mShowFriend = (Friend) intent.getSerializableExtra("friend");
	...
	public void initData() {
		...
		final ViewGroup group = (ViewGroup) findViewById(R.id.ll_content);
		...
		rl_business_back = (RelativeLayout) findViewById(R.id.rl_business_back);
		...
		final TextView tv_bighead = (TextView) findViewById(R.id.tv_bighead);
		TextView tv_squarepanel_name = (TextView) findViewById(R.id.tv_squarepanel_name);
		TextView tv_grouppanel_name = (TextView) findViewById(R.id.tv_grouppanel_name);
		TextView tv_msgpanel_name = (TextView) findViewById(R.id.tv_msgpanel_name);
		TextView tv_nickname = (TextView) findViewById(R.id.tv_nickname);
		TextView tv_phone = (TextView) findViewById(R.id.tv_phone);
		TextView tv_mainbusiness = (TextView) findViewById(R.id.tv_mainbusiness);
		TextView tv_id = (TextView) findViewById(R.id.tv_id);
		TextView tv_sex = (TextView) findViewById(R.id.tv_sex);
		tv_alias = (TextView) findViewById(R.id.tv_alias);
		tv_alias_title = (TextView) findViewById(R.id.tv_alias_title);
		...
		if (mStatus == SHOW_TEMPFRIEND) {
			...
			button1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					Alert.showMessage("功能正在完善中...");
					// mMainModeManager.mAddFriendFragment.mAddFriend =
					// mShowFriend;
					// mMainModeManager
		...
		app.fileHandler.getBackgroundImage(backgroudFileName, new FileResult() {
			...
			public void onResult(String where, Bitmap bitmap) {
				getWindow().setBackgroundDrawable(
						new BitmapDrawable(app.fileHandler.bitmaps
	...
	View generateFriendGroup() {
		View groupView = findViewById(R.id.tv_group_layout);
		gridView = (GridView) findViewById(R.id.tv_gridview);
