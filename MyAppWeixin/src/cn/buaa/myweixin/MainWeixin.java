...
public class MainWeixin extends Activity {
	 ...
	 */
	/*
	 * public class MyOnClickListener implements View.OnClickListener { private
	 * int index = 0;
	 * 
	 * public MyOnClickListener(int i) { index = i; }
	 * 
	 * @Override public void onClick(View v) { mTabPager.setCurrentItem(index);
	 * } };
	 */
		...
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) { // 获取
			...
			if (!menu_display) {
				...
				menuWindow = new PopupWindow(layout,
						...
						android.view.ViewGroup.LayoutParams.WRAP_CONTENT); // 后两个参数是width和height
	...
	// 和客服开始聊天
	public void startservicechat(View v) {
	...
	public void btnsearchfriends(View v) {
		Intent intent = new Intent(MainWeixin.this, SearchFriendsDialog.class);
		startActivity(intent);
	}

	//
	public void showMainTopCenterDialog(View v) {
		Intent intent = new Intent(MainWeixin.this, MainTopCenterDialog.class);
		startActivity(intent);
	}
	...
	public void showCommunity(View v) {
