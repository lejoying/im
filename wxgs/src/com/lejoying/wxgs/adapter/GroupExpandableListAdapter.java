...
public class GroupExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    public GroupExpandableListAdapter(Context context,String[] group,String[][] buddy){  
	...
	public View getChildView(int groupPosition, int childPosition, boolean arg2, View convertView,  
            ViewGroup arg4) {  
		 convertView = inflater.inflate(R.layout.groupexpandablelistadapter_child, null);  
	        TextView nickTextView=(TextView) convertView.findViewById(R.id.groupexpandable_listview_child_nick);  
