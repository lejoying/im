...
/**
 * Class that starts and stops item drags on a {@link DragSortListView} based on touch gestures. This class also inherits from {@link SimpleFloatViewManager}, which provides basic float View creation.
 * 
 * An instance of this class is meant to be passed to the methods {@link DragSortListView#setTouchListener()} and {@link DragSortListView#setFloatViewManager()} of your {@link DragSortListView} instance.
 */
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
	...
	public DragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId, int flingHandleId) {
		...
		mTouchSlop = (int) (ViewConfiguration.get(dslv.getContext()).getScaledTouchSlop() + TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 100, mDslv.getDisplayMetrics()));
	...
	/**
	 * Checks for the touch of an item's drag handle (specified by {@link #setDragHandleId(int)}), and returns that item's position if a drag handle touch was detected.
	 * 
	 * @param ev
	 *            The ACTION_DOWN MotionEvent.
	 * 
