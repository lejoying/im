var AlipayConfig = {
    ...
    notify_url: "http://115.28.51.197:8071/alipay/paynotify?",
...
//    console.log(req.query());
    ...
    console.log(trade_no + "支付宝交易号");
    console.log(order_no + "获取订单号");
    console.log(total_fee + "获取总金额");
    console.log(subject + "商品名称");
    var body = "";
