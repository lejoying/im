...
alipayManage.paynotify = function (data, response) {
    response.asynchronous = 1;
...
alipayManage.batch_trans_notify = function (data, response) {
    response.asynchronous = 1;
...
//    console.log("https://" + AlipayConfig.ALIPAY_HOST + "/" + sURL);
    ...
    console.log(sURL);
    response.redirect("https://" + AlipayConfig.ALIPAY_HOST + "/" + sURL);
//    });
};
alipayManage.batch_trans_notify_by_notify_url = function (data, response) {
    response.asynchronous = 1;
    var counts = 0;
