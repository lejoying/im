...
$(document).ready(function () {
    var doc = document;
    _wheelData = -1;
//    window.sessionStorage.setItem("_wheelData", _wheelData);
...
//                    }
                    ...
                    _wheelData = _t;
                    window.globaldata.tempData = _t;
//                    window.sessionStorage.setItem("_wheelData",_t);
                }
            }
...
//                    _wheelData =  parseInt(window.globaldata.tempData);
                        if (_wheelData >= 0) {
                            flag = _wheelData;
...
//                        flag = wheelFlag / 12;
//                        if (window.globaldata.tempData != 0) {
//                            flag = window.globaldata.tempData;
//                        } else {
                            flag = wheelFlag / 12;
//                        }
                        }
...
//                        alert(flag);
                        window.globaldata.tempData = flag;
                    }
                    setPosition(window.globaldata.tempData);  //(position + 10) * 12 + data
//                    window.sessionStorage.setItem("_wheelData", flag);
//                    _wheelData = flag;
        ...
        _clickScroll: function (element, mainBox, contentBox) {
            ...
            p.onclick = function (event) {
                ...
                if (t != element) {
                    ...
                    _wheelData = _top;
                    window.globaldata.tempData = _top;
//                    alert(_top);
//                    window.sessionStorage.setItem("_wheelData", _wheelData);
