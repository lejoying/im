/*** Generated by streamline 0.8.1 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; (function() {
  ...
  module.exports = PropertyContainer = (function() {
    ...
    PropertyContainer.prototype["delete"] = function PropertyContainer_prototype_delete__1(_) { var error, response, __this = this; var __frame = { name: "PropertyContainer_prototype_delete__1", line: 90 }; return __func(_, this, arguments, PropertyContainer_prototype_delete__1, 0, __frame, function __$PropertyContainer_prototype_delete__1() {
        ...
        if (!__this.exists) { return _(null); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$PropertyContainer_prototype_delete__1() {
              ...
              return __this._request.del(__this.self, __cb(_, __frame, 6, 19, function ___(__0, __1) { response = __1;
                ...
                __this._data.self = null; __then(); }, true)); }); })(function ___(_error, __result) { __tryCatch(_, function __$PropertyContainer_prototype_delete__1() { if (_error) {
