...
public class RelationManagerImpl implements RelationManager {
	...
	public void addfriend(Map<String, String> param,
		...
		MCNetTools.ajax(context, "/api2/relation/addfriend", param, true,
	...
	public void getfriends(Map<String, String> param,
			ResponseListener responseListener) {
		MCNetTools.ajax(context, "/api2/relation/getfriends", param, true,
				HttpTools.SEND_POST, 5000, responseListener);
	}
	...
	public void getcommunities(Map<String, String> param,
			ResponseListener responseListener) {
		MCNetTools.ajax(context, "/api2/relation/getcommnities", param, true,
				HttpTools.SEND_POST, 5000, responseListener);
	}
	...
	public void addcircle(Map<String, String> param,
			ResponseListener responseListener) {
		MCNetTools.ajax(context, "/api2/relation/addcircle", param, true,
				HttpTools.SEND_POST, 5000, responseListener);
	}
	...
	public void getcirclesandfriends(Map<String, String> param,
			ResponseListener responseListener) {
		MCNetTools.ajax(context, "/api2/relation/getcirclesandfriends", param,
	...
	public void getaskfriends(Map<String, String> param,
			ResponseListener responseListener) {
		MCNetTools.ajax(context, "/api2/relation/getaskfriends", param, true,
				HttpTools.SEND_POST, 5000, responseListener);
	}
	...
	public void addfriendagree(Map<String, String> param,
			ResponseListener responseListener) {
		MCNetTools.ajax(context, "/api2/relation/addfriendagree", param, true,
				HttpTools.SEND_POST, 5000, responseListener);
	}
